...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Employee\\Documents\\GitHub\\AB_pic\\AB_pic_singleT2.py',
...
for thisTrials2 in trials2:
    ...
    curStimTim = .2 #-((np.log(1/.90 - 1) + B0) / B1
    ...
    trials2.addData('text_8.started', text_8.tStartRefresh)
    trials2.addData('text_8.stopped', text_8.tStopRefresh)
