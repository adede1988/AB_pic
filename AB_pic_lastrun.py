...
for thisTrials2 in trials2:
    ...
    for thisComponent in optionsMainComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    trials2.addData('option1_2.started', option1_2.tStartRefresh)
    trials2.addData('option1_2.stopped', option1_2.tStopRefresh)
    trials2.addData('option2_2.started', option2_2.tStartRefresh)
    trials2.addData('option2_2.stopped', option2_2.tStopRefresh)
    trials2.addData('text_5.started', text_5.tStartRefresh)
    trials2.addData('text_5.stopped', text_5.tStopRefresh)
    ...
    for thisComponent in trialMain2Components:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    trials2.addData('displayPicture_3.started', displayPicture_3.tStartRefresh)
    trials2.addData('displayPicture_3.stopped', displayPicture_3.tStopRefresh)
    trials2.addData('polygon_13.started', polygon_13.tStartRefresh)
    trials2.addData('polygon_13.stopped', polygon_13.tStopRefresh)
    ...
    for thisComponent in response2MainComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    trials2.addData('polygon_6.started', polygon_6.tStartRefresh)
    trials2.addData('polygon_6.stopped', polygon_6.tStopRefresh)
    if key_resp_5.keys == 'right' and skip2 == False:
        cor2 = 1
    elif key_resp_5.keys == 'left' and skip2 == True:
        cor2 = 1
    else: 
        cor2 = 0
    ...
    trials2.addData('option1_t2_2.started', option1_t2_2.tStartRefresh)
    trials2.addData('option1_t2_2.stopped', option1_t2_2.tStopRefresh)
    # check responses
    if key_resp_5.keys in ['', [], None]:  # No response was made
        key_resp_5.keys = None
    trials2.addData('key_resp_5.keys',key_resp_5.keys)
    if key_resp_5.keys != None:  # we had a response
        trials2.addData('key_resp_5.rt', key_resp_5.rt)
    trials2.addData('key_resp_5.started', key_resp_5.tStartRefresh)
    trials2.addData('key_resp_5.stopped', key_resp_5.tStopRefresh)
